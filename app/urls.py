...
urlpatterns = [
    ...
    url(r'^site_admin/blogs/(?P<pk>\d+)/$', views.AdminBlogList.as_view(), name='admin_blog_posts'),
    ...
    url(r'^site_admin/portfolio/(?P<pk>\d+)/$', views.PortfolioAdminList.as_view(), name='portfolio_admin_list'),
